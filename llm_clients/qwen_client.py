"""
Qwen3 Zettelkasten client — Phase 5
OpenAI-compatible via OpenRouter. Same tools schema as gpt4_client.py.
"""
...
# OpenRouter endpoint — swap base_url for DashScope if preferred:
...
def run(user_message: str):
    ...
    final = client.chat.completions.create(model="qwen/qwen3-235b-a22b", messages=messages)
