"""
Kimi K2 Zettelkasten client — Phase 5
Drop-in OpenAI SDK replacement — only base_url differs from gpt4_client.py.
"""
...
def run(user_message: str):
    ...
    final = client.chat.completions.create(model="moonshot-v1-8k", messages=messages)
